...
function add_css(target) {
  append_styles(target, "svelte-z5efez", ":root{--sc-dot-size:6px;--sc-active-dot-size:8px;--sc-dot-size-animation-time:250ms}.sc-carousel-dot__dot.svelte-z5efez{background-color:var(--sc-color-rgb-light);border-radius:50%;display:inline-block;opacity:0.5;transition:opacity 100ms ease,\r\n      height var(--sc-dot-size-animation-time) ease,\r\n      width var(--sc-dot-size-animation-time) ease;cursor:pointer;-webkit-tap-highlight-color:transparent;height:var(--sc-dot-size);width:var(--sc-dot-size)}.sc-carousel-dot__dot.svelte-z5efez:hover{opacity:0.9}.sc-carousel-dot__dot_active.svelte-z5efez{opacity:0.7;height:var(--sc-active-dot-size);width:var(--sc-active-dot-size)}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
function create_fragment(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(button, "class", "sc-carousel-button sc-carousel-dot__dot svelte-z5efez");
      toggle_class(
        button,
...
function add_css2(target) {
  append_styles(target, "svelte-1c8x102", ".sc-carousel-dots__container.svelte-1c8x102{display:flex;align-items:center;justify-content:center;flex-wrap:wrap;padding:0 30px}.sc-carousel-dots__dot-container.svelte-1c8x102{height:calc(var(--sc-dot-size) + 14px);width:calc(var(--sc-dot-size) + 10px);display:flex;align-items:center;justify-content:center}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
...
function add_css3(target) {
  append_styles(target, "svelte-t8cm1p", ":root{--sc-arrow-size:2px}.sc-carousel-arrow__circle.svelte-t8cm1p{width:20px;height:20px;border-radius:50%;background-color:var(--sc-color-rgb-light-50p);display:flex;align-items:center;justify-content:center;transition:opacity 100ms ease;cursor:pointer;-webkit-tap-highlight-color:transparent}.sc-carousel-arrow__circle.svelte-t8cm1p:hover{opacity:0.9}.sc-carousel-arrow__arrow.svelte-t8cm1p{border:solid var(--sc-color-hex-dark);border-width:0 var(--sc-arrow-size) var(--sc-arrow-size) 0;padding:var(--sc-arrow-size);position:relative}.sc-carousel-arrow__arrow-next.svelte-t8cm1p{transform:rotate(-45deg);left:calc(var(--sc-arrow-size) / -2)}.sc-carousel-arrow__arrow-prev.svelte-t8cm1p{transform:rotate(135deg);right:calc(var(--sc-arrow-size) / -2)}.sc-carousel-arrow__circle_disabled.svelte-t8cm1p,.sc-carousel-arrow__circle_disabled.svelte-t8cm1p:hover{opacity:0.5}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
function create_fragment3(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(button, "class", "sc-carousel-button sc-carousel-arrow__circle svelte-t8cm1p");
      toggle_class(
        button,
...
function add_css4(target) {
  append_styles(target, "svelte-1ws0dj9", ".sc-carousel-progress__indicator.svelte-1ws0dj9{height:100%;background-color:var(--sc-color-hex-dark-50p)}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJmaWxlIjoiUHJvZ3Jlc3Muc3ZlbHRlIiwibWFwcGluZ3MiOiJBQW1CRSxnREFDRSxXQUFZLENBQ1osNkNBQ0YiLCJuYW1lcyI6W10sImlnbm9yZUxpc3QiOltdLCJzb3VyY2VzIjpbIlByb2dyZXNzLnN2ZWx0ZSJdfQ== */");
}
...
function add_css5(target) {
  append_styles(target, "svelte-tf2ku8", ":root{--sc-color-rgb-light-50p:rgba(93, 93, 93, 0.5);--sc-color-rgb-light:#5d5d5d;--sc-color-hex-dark-50p:rgba(30, 30, 30, 0.5);--sc-color-hex-dark:#1e1e1e}.sc-carousel__carousel-container.svelte-tf2ku8{display:flex;width:100%;flex-direction:column;align-items:center}.sc-carousel__content-container.svelte-tf2ku8{position:relative;display:flex;width:100%}.sc-carousel__pages-window.svelte-tf2ku8{flex:1;display:flex;overflow:hidden;box-sizing:border-box;position:relative}.sc-carousel__pages-container.svelte-tf2ku8{width:100%;display:flex;transition-property:transform}.sc-carousel__arrow-container.svelte-tf2ku8{padding:5px;box-sizing:border-box;display:flex;align-items:center;justify-content:center}.sc-carousel-progress__container.svelte-tf2ku8{width:100%;height:5px;background-color:var(--sc-color-rgb-light-50p);position:absolute;bottom:0}.sc-carousel-button{all:unset;cursor:pointer}.sc-carousel-button:focus{outline:5px auto}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
...
function fallback_block_2(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(div, "class", "sc-carousel__arrow-container svelte-tf2ku8");
...
function create_if_block_2(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(div, "class", "sc-carousel-progress__container svelte-tf2ku8");
...
function create_fragment5(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(div0, "class", "sc-carousel__pages-container svelte-tf2ku8");
      ...
      attr_dev(div1, "class", "sc-carousel__pages-window svelte-tf2ku8");
      add_location(div1, file5, 269, 4, 6592);
      attr_dev(div2, "class", "sc-carousel__content-container svelte-tf2ku8");
      add_location(div2, file5, 257, 2, 6209);
      attr_dev(div3, "class", "sc-carousel__carousel-container svelte-tf2ku8");
