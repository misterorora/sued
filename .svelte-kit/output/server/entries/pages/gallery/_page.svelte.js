import { c as create_ssr_component, d as createEventDispatcher, f as each, v as validate_component, e as escape, o as onDestroy, h as add_attribute } from "../../../chunks/ssr.js";
...
const Dots = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="sc-carousel-dots__container svelte-1oj5bge">${each(Array(pagesCount), (_, pageIndex) => {
    return `<div class="sc-carousel-dots__dot-container svelte-1oj5bge">${validate_component(Dot, "Dot").$$render($$result, { active: currentPageIndex === pageIndex }, {}, {})} </div>`;
  })} </div>`;
});
const PREV = "prev";
const NEXT = "next";
...
const Carousel = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="sc-carousel__carousel-container svelte-uwo0yk"><div class="sc-carousel__content-container svelte-uwo0yk">${arrows ? `${slots.prev ? slots.prev({ showPrevPage: methods.showPrevPage }) : ` <div class="sc-carousel__arrow-container svelte-uwo0yk">${validate_component(Arrow, "Arrow").$$render(
    $$result,
    {
      direction: "prev",
    ...
    {},
    {}
  )}</div> `}` : ``} <div class="sc-carousel__pages-window svelte-uwo0yk"${add_attribute("this", pageWindowElement, 0)}><div class="sc-carousel__pages-container svelte-uwo0yk" style="${"transform: translateX(" + escape(offset, true) + "px); transition-duration: " + escape(durationMs, true) + "ms; transition-timing-function: " + escape(timingFunction, true) + ";"}"${add_attribute("this", particlesContainer, 0)}>${slots.default ? slots.default({ loaded, currentPageIndex }) : ``}</div> ${autoplayProgressVisible ? `<div class="sc-carousel-progress__container svelte-uwo0yk">${validate_component(Progress, "Progress").$$render($$result, { value: progressValue }, {}, {})}</div>` : ``}</div> ${arrows ? `${slots.next ? slots.next({ showNextPage: methods.showNextPage }) : ` <div class="sc-carousel__arrow-container svelte-uwo0yk">${validate_component(Arrow, "Arrow").$$render(
    $$result,
    {
      direction: "next",
...
const image1 = "/_app/immutable/assets/1.CeMmf8W8.jpg";
const image2 = "/_app/immutable/assets/2.D5tgOxmw.jpg";
const image3 = "/_app/immutable/assets/3.CykX_cGv.jpg";
const image4 = "/_app/immutable/assets/4.hJGCats9.jpg";
const css = {
  code: ".img-container.svelte-jb2eai.svelte-jb2eai{width:100%;height:100%;display:flex;justify-content:center;align-items:center;overflow:hidden}.img-container.svelte-jb2eai img.svelte-jb2eai{max-width:100%;max-height:100%;object-fit:contain;object-position:center}.adjust.svelte-jb2eai.svelte-jb2eai{width:65%;height:50%;position:absolute;top:50%;left:50%;transform:translate(-50%, -50%);display:flex;justify-content:center;align-items:center;border-radius:5px}",
  map: null
};
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `  <main><div class="adjust svelte-jb2eai">${validate_component(Carousel, "Carousel").$$render($$result, { autoplay: "2000" }, {}, {
    default: () => {
      return ` ${each(imageGallery, (src, imageIndex) => {
        return ` <div class="img-container svelte-jb2eai"><img${add_attribute("src", src, 0)} alt="" class="svelte-jb2eai"> </div>`;
      })}`;
    }
  })}</div> </main>`;
});
